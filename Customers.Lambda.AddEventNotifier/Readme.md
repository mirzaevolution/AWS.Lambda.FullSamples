...
Execute unit tests
```
    cd "Customers.Lambda.AddEventNotifier/test/Customers.Lambda.AddEventNotifier.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Customers.Lambda.AddEventNotifier/src/Customers.Lambda.AddEventNotifier"
